...
public interface SalesOrderRepository extends JpaRepository<SalesOrder, Integer> {
    ...
    List<SalesOrder> findSOWiseSalesReportByTheSelectedDate(@Param("assignedId") int assignedId, @Param("startDate") LocalDate startDate, @Param("startDate") LocalDate endDate);
    ...
    List<SalesOrder> findOderStatusByOutletId(@Param("outletId") int outletId, @Param("orderStatus") boolean orderStatus, @Param("startDate") LocalDate startDate, @Param("endDate") LocalDate endDate);
    ...
    @Query("SELECT s.outlet.outletId,s.outlet.name, COUNT(s.outlet.outletId) AS outletCount FROM SalesOrder s where s.createdAt between :startDate and :endDate GROUP BY s.outlet.outletId,s.outlet.name ORDER BY outletCount DESC ")
    List<Object[]> findOrderedMostAndMinOutlet(@Param("startDate") LocalDate startDate, @Param("endDate") LocalDate endDate);
