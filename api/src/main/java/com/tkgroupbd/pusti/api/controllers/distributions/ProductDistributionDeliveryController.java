...
@Tag(name = "ProductDistributionDelivery")
@RestController
...
public class ProductDistributionDeliveryController {
    ...
    @PostMapping("/add")
    public ResponseEntity<MessageResponse> createDistributionDelivery(@RequestBody ProductDistributionDeliveryRequest request) {
       MessageResponse distributionDelivery = service.createDeleveryAndUpdateStockInDistributionDelivery(request,request.getSku(), request.getQuantity());
